...
verificationRouter.post('/:id/approve', authorize({ roles: ['CENTRAL_ADMIN', 'DISTRICT_ADMIN'] }), approve)

// POST /api/verification/:id/reject — reject verification
verificationRouter.post('/:id/reject', authorize({ roles: ['CENTRAL_ADMIN', 'DISTRICT_ADMIN'] }), reject)